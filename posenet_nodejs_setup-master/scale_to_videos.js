...
const { abs } = require('@tensorflow/tfjs-node');
...
if (getArgumentValue === undefined) {
    photo_path_to_frames = "C:\\Users\\tazer\\Documents\\ASU\\CSE-535\\ASL_Project\\Juan-ASL-Alphabet\\";
} else {
...
// Measure 1/3 of the lenght from the elbow to wrist
